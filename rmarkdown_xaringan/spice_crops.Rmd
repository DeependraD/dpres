...
---
background-image: url("../images/vegetables/Umbellifers_seeds.jpeg")
...
```{r ginger-bot, fig.width=6, out.width="100%"}
...
knitr::include_graphics("../images/vegetables/Ginger_rhizome.jpg")
```

---
background-image: url("../images/vegetables/Ginger_perfumery.jpg")
...
- Warm and humid climate with average temperature of $25-30^oC$ favors better growth.
...
- Early stage fresh ginger: 600 $kg\ ropani^{-1}$
- Dried ginger: 1000 $kg\ ropani^{-1}$
...
drainage, seed treatment, Spray of Bavistin + Redomil 0.2% a.i (1:1) + Brassica oilseed cake @ 2 $t\ ha^{-1}$.
...
- Borer: 
  - Drills hole in the pseudostem and progresses to top. Dead heart symptom. For chemical control, Thiomethoxam 25% w.g 0.2 $g\ ltr^{-1}$ water, or imidachloprid 17.8% s.l 0.25 $ml\ ltr^{-1}$ at an interval of 15 days at least twice. Light traps can control population of mature Moths.
- Rhizome fly: 
...
```{r ginger-insects, out.width="100%", fig.cap="Grub and borer infestation in ginger"}
...
- Temperature requirement: $20-30^oC$
...
- Optimum temperature($\ ^oC$): 9-26/17
...
- Crops is more generally adaptated to warmer temperatures in the 21-25 $\ ^oC$ range.
- Temperature: 7-27/20 $\ ^oC$.
